...
### Command frontmatter schema documentation

- https://code.claude.com/docs/en/slash-commands#frontmatter-reference

### Output style frontmatter schema documentation

- https://code.claude.com/docs/en/output-styles#frontmatter

### Rule frontmatter schema documentation
...
- [Claude Code documentation for agents](https://code.claude.com/docs/en/sub-agents/)
- [Claude Code documentation for skills](https://code.claude.com/docs/en/skills/)
- [Claude Code documentation for commands](https://code.claude.com/docs/en/slash-commands/)
- [Claude Code documentation for output styles](https://code.claude.com/docs/en/output-styles/)
- [Claude Code documentation for plugins](https://code.claude.com/docs/en/plugins/)
