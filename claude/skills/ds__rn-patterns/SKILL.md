...
```tsx
<View className="bg-surface-raised rounded-xl border-continuous border border-default shadow-elevation-low p-component-md">
...
> See ds\_\_component-variant for tv() variant definitions (buttons, cards, inputs).
...
> For tv() card definitions, see ds\_\_component-variant.
